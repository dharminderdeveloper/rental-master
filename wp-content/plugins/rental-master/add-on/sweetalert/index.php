...
function abr_add_sweetalert_js(){
	wp_register_script('sweet-js',RM_PLUGIN_DIR_URL.'/add-on/sweetalert/sweetalert.min.js');
...
function abr_add_sweetalert_css(){
	wp_enqueue_style('sweet-css',RM_PLUGIN_DIR_URL.'/add-on/sweetalert/sweetalert.css');
}
?>